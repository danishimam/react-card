...
function App() {
  return (
    <div style={{display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr 1fr", margin: "auto"}}>
      ...
      <Card image="https://images.unsplash.com/photo-1693407241318-fc9a95f076f0?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fGF2YWNhcmRvfGVufDB8fDB8fHww" name="Avacado" price="₹600"/>
